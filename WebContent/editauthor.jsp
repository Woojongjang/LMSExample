...
<div>
	...
	<form action="editAuthor" method="post">
		<div class="modal-body" class="container col-md-12">
			...
			Author Name: <input type="text" class="form-control" name="authorName" id="authorName" value="<%=authorName%>"><br />
			Author ID: <input type="text" class="form-control" name="authorId" id="authorId" value="<%=authorId%>" readonly="readonly">
		</div>
